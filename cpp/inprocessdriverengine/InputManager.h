...
public:
  ...
  int PerformInputSequence(InputContext context,
                           const Json::Value& sequence,
                           std::string* error_info);
  void Reset(InputContext context);
 ...
 private:
  int PointerMoveTo(InputContext context,
                    const Json::Value& move_to_action,
                    InputState* input_state);
  int PointerDown(InputContext context,
                  const Json::Value& down_action,
                  InputState* input_state);
  int PointerUp(InputContext context,
                const Json::Value& up_action,
                InputState* input_state);
  int KeyDown(InputContext context,
              const Json::Value& down_action,
              InputState* input_state);
  int KeyUp(InputContext context,
            const Json::Value& up_action,
            InputState* input_state);
  int Pause(InputContext context,
