...
#define WD_NOTIFY_PENDING_NEW_WINDOW WM_APP + 206
#define WD_NOTIFY_PENDING_REACQUIRE WM_APP + 207
#define WD_NOTIFY_PENDING_FILE_SELECTION WM_APP + 208

#define WD_GET_SESSION_SETTING WM_APP + 300
#define WD_SET_SESSION_SETTING WM_APP + 301
#define WD_SERIALIZE_SESSION_SETTINGS WM_APP + 302
...
#define SESSION_SETTING_FILE_DIALOG_TIMEOUT 8
#define SESSION_SETTING_USE_LEGACY_FILE_DIALOG_HANDLING 9

#define COPYDATA_COMMAND 0
#define COPYDATA_RESPONSE 1
#define COPYDATA_UPDATE_SETTINGS 2
#define COPYDATA_SAME_WINDOW_PROCESS_ID_LIST 3
#define COPYDATA_NEW_WINDOW_PROCESS_ID_LIST 4
